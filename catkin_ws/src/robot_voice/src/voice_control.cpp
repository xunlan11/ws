...
void iattextCallback(const std_msgs::String::ConstPtr& msg)
{
    ...
    if(dataString.find("ST.") != dataString.npos)
    {
    ...
    else if(dataString.find("Back.") != dataString.npos)
    {
    ...
    else if(dataString.find("Turn left.") != dataString.npos)
    {
    ...
    else if(dataString.find("Turn right.") != dataString.npos)
    {
    ...
    else if(dataString.find("Stop") != dataString.npos)
    {
